...
of 27 parts in the qualifying snapshot showing zero stock — the rest are mostly
individual resistor and capacitor values — and the only individually notable
component among them apart from the FORESEE eMMC (C719499). See
`ISSUES.md`. [1]
