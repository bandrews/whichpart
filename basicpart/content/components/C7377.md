...
| Operating temperature | Industrial −40 °C to +85 °C, extended −40 °C to +125 °C; the `I` in `MCP6002T-I/SN` is the industrial grade [1] | The catalog records −40 °C to +125 °C. See the note below. |
...
- **1 MHz bandwidth.** Fine for sensors and filters; not for audio power stages
  or fast signals.
- **The order code says industrial (`-I`), which Microchip specifies as −40 °C to
  +85 °C**, while the catalog records −40 °C to +125 °C — Microchip's *extended*
  grade. See `ISSUES.md`.
