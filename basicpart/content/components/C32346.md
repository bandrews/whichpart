...
**Temperature affects a watch crystal parabolically, not linearly.** A 32.768 kHz
tuning-fork crystal is cut so its frequency peaks near 25 °C and falls off on
both sides, typically by about 0.034 ppm per °C² of deviation. At 0 °C or 50 °C
that is roughly −21 ppm; at −20 °C or 70 °C, roughly −69 ppm. A clock that lives
outdoors will run slow in both summer and winter — which is why
temperature-compensated RTC modules exist.
