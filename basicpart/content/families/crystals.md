...
driven with microwatts and can be permanently damaged by over-driving. That is
why RTC oscillator circuits include a series resistor and why you should not
transplant component values between the two crystal types.
