...
| Output drive | 500 mA per channel; channels may be paralleled for more [1] | 500 mA is the rating for a *single* output. Driving all seven at once is limited by package power dissipation, not by this number. |
| Propagation delay | Not specified as a delay; the collector-emitter saturation voltage is 1.1 V maximum at 100 mA, 1.3 V at 200 mA and 1.6 V at 350 mA [1] | That saturation voltage is the real cost of a Darlington: at 350 mA you lose 1.6 V and dissipate over half a watt in the chip. |
| Operating temperature | Junction temperature −40 °C to +125 °C [1] | Specified as a junction, not ambient, limit — so it is really a power-dissipation budget. |
