...
This one runs at 16 MHz in a 3.2 × 2.5 mm four-pad surface-mount package. Two of the
...
|---|---|---|
| Nominal frequency | 16 MHz [1] | 16 MHz is the ATmega328P's usual clock in Arduino designs, and a common choice for STM32 HSE input. |
| Frequency tolerance | ±10 ppm at room temperature [1] | How far off it is when new, at 25 °C. 10 ppm is about 0.9 seconds per day. |
| Load capacitance | 9 pF [1] | **The number that matters most.** Your two load capacitors, plus the microcontroller's pin capacitance and stray board capacitance, must add up to this. Get it wrong and the frequency is wrong. |
...
capacitance. For a 9 pF crystal with matched capacitors, that means each capacitor
...
the 2026-07-24 snapshot: 144,946 in stock, $0.093 at quantity 1, falling to $0.048 at 6,000. [1]

## Sources

1. JLCPCB / LCSC catalog record for C13738, snapshot 2026-07-24
