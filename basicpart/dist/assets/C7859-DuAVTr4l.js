...
| Propagation delay | With a 50 pF load, a 5 V A-side and a 2.7–3.6 V B-side: 6.7 ns maximum A→B and 6.1 ns maximum B→A, with a 1 ns minimum in both directions [1] | Fast enough for most parallel buses, but it is a real delay to include in timing budgets — and the *minimum* matters too if you are relying on hold time. |
