...
This one runs at 12 MHz in a 3.2 × 2.5 mm four-pad surface-mount package. Two of the
...
|---|---|---|
| Nominal frequency | 12 MHz [1] | 12 MHz is the frequency the RP2040's USB bootloader requires, and a convenient multiple for USB timing generally. |
| Frequency tolerance | ±10 ppm at room temperature [1] | How far off it is when new, at 25 °C. 10 ppm is about 0.9 seconds per day. |
| Load capacitance | 20 pF [1] | **The number that matters most.** Your two load capacitors, plus the microcontroller's pin capacitance and stray board capacitance, must add up to this. Get it wrong and the frequency is wrong. |
| Equivalent series resistance | 80 Ω [1] | How hard the oscillator has to work. Higher ESR needs more drive; if it exceeds what your microcontroller's oscillator can supply, it will not start. |
...
capacitance. For a 20 pF crystal with matched capacitors, that means each capacitor
...
crystal's ESR by a factor of about five. At 80 Ω that is rarely a problem for
...
the 2026-07-24 snapshot: 260,055 in stock, $0.095 at quantity 1, falling to $0.048 at 6,000. [1]

## Sources

1. JLCPCB / LCSC catalog record for C9002, snapshot 2026-07-24
