...
**Power-down current is under 1 µA typical.** For a battery product that reads
the flash occasionally and sleeps the rest of the time, the flash is essentially
free to leave connected. [1]
...
- **Erases are slow and coarse.** A 32 kB block erase takes 120 ms; you cannot
  rewrite a single byte in place.
...
32 kB block erase, 1 µA standby current and −40 °C to +85 °C, all matching the
datasheet. [2]
