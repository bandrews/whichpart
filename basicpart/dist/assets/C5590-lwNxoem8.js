...
| Propagation delay | 15 ns typical, 22 ns maximum at V<sub>CC</sub> = 4.5 V; 7 ns typical at 6 V; 75 ns typical at 2 V [1] | Fast enough that it rarely matters in hobby-scale designs; the 2 V figure is the one to watch. |
...
**Delay scales strongly with supply.** 7 ns typical at 6 V, 15 ns at 4.5 V,
75 ns at 2 V. In a low-voltage design the propagation delay is an order of
magnitude worse. [1]
