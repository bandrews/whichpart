...
| Input offset voltage | 2.0 mV typical at 25 °C; the LM2904 column of the datasheet gives a 7.0 mV maximum over V<sub>CC</sub> = 5 V to 30 V [1] | The catalog quotes the 2 mV typical figure where it quotes 7 mV maximum for the LM358 — the same silicon, differently reported. |
| Gain bandwidth | Not stated in the electrical characteristics table of this document; the family is conventionally about 1 MHz [1] | Slow, like the LM358. |
