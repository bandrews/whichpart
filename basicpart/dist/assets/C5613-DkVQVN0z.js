...
| Propagation delay | Clock or enable to the serial output, 50 pF load: 18 ns typical and 33 ns maximum at V<sub>CC</sub> = 4.5 V and 25 °C, relaxing to 50 ns over the −40 °C to +125 °C range this order code is graded for. The parallel-load path (D7 to Q7) is faster at 13 ns typical, 24 ns maximum. Maximum clock frequency 30 MHz guaranteed and 51 MHz typical at 4.5 V, rising to 35 MHz guaranteed and 61 MHz typical at 6 V [1] | Fast enough that the microcontroller's software loop is always the bottleneck. Note the catalog's 35 MHz is the 6 V guaranteed minimum, not a 5 V figure. [2] |
