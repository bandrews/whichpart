...
| Gain bandwidth | Not applicable; response time is 1.3 µs typical with a 100 mV step and 5 mV of overdrive, and large-signal response time is 300 ns maximum [1] | The 1.3 µs figure assumes only 5 mV of overdrive; onsemi notes larger overdrive gives faster response. |
| Output swing | Open collector. Output sink current 6.0 mA minimum, 16 mA typical; saturation voltage 150 mV typical, 400 mV maximum at 4 mA sink [1] | The low side is a saturated transistor; the high side is whatever your pull-up resistor is tied to. |
| Supply current | 0.4 mA total, independent of supply voltage [1] | Very low, and notably it does not rise as you increase the supply. |
...
**Input bias current is 25 nA and input offset current 5.0 nA** — low enough that
a resistor divider setting your threshold can use fairly high values without
introducing much error. [1]
...
delay, 2 V–36 V single supply, ±18 V dual and 0 °C to +70 °C, all matching the
datasheet. [2]
