...
| Capacitance | 3.5 pF typical and 5.0 pF maximum I/O to ground; 2.5 pF typical and 4.0 pF maximum I/O to I/O, both at 0 V and 1 MHz [1] | The headline number, and the reason this part costs more than a plain 5 V clamp. Design high-speed lines against the maxima — 5 pF on a USB 2.0 pair is already noticeable. |
...
ProTek's 30 A peak pulse current is footnoted "across TVS only — pin 2 to pin 5",
which is the same point from the datasheet's side: the energy ends up in that one
central TVS however many I/O lines you use. [1]
