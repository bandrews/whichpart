...
| Propagation delay | 15 ns typical, 22 ns maximum at V<sub>CC</sub> = 4.5 V; 11 ns typical at 5 V with a 15 pF load; catalog gives a 35 MHz clock frequency [1] [2] | Fast enough that the microcontroller's software loop is always the bottleneck. |
