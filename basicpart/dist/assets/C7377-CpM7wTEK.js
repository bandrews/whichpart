...
| Input offset voltage | ±4.5 mV maximum, measured with the common-mode input at V<sub>SS</sub>; input offset drift 2 µV/°C [1] | Similar to an LM358's — this is a general-purpose part, not a precision one. The catalog's figure matches the datasheet exactly. The drift is genuinely good. [2] |
...
| Output swing | Within 25 mV of either rail at 5.5 V with 0.5 V of input overdrive. Output short-circuit current ±23 mA at 5.5 V, falling to ±6 mA at 1.8 V [1] | "Rail-to-rail" always leaves a small residual, and here it is 25 mV rather than the LM358's 1.5 V. Note that the drive current scales with supply: the catalog's 23 mA is the 5.5 V figure, and at 1.8 V you get a quarter of it. [2] |
